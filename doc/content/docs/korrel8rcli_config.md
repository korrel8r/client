---
title: config
description: Change configuration settings on the server
---
## korrel8rcli config

Change configuration settings on the server

```
korrel8rcli config [flags]
```
...
```
  -h, --help              help for config
      --set-verbose int   Set verbose level for logging
```
